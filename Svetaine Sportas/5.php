...
if (!file_exists("Penktas_dvitaskiai.txt")) { // patikrina, ar egzistuoja failas
    exit ("No messages!");
    ...
    $fp = fopen ("Penktas_dvitaskiai.txt", "r+");
    $n = file("Penktas_dvitaskiai.txt");
    fclose($fp);
    ...
    if (!file_exists("Tritaskiai/5.txt")) { // patikrina, ar egzistuoja failas
        exit ("No messages!");
    } else { // jei failas yra, jis yra skaitomas, t.y. atidaromas (fopen) ir tekstas is failo nuskaitomas ir perkeliamas i masyva, ir uzdaromas (fclose) "file"
        $fp = fopen ("Tritaskiai/5.txt", "r+");
        $n = file("Tritaskiai/5.txt");
        fclose($fp);
