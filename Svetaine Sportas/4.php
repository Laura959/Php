...
if (!file_exists("Ketvirtas_dvitaskiai.txt")) { // patikrina, ar egzistuoja failas
    exit ("No messages!");
    ...
    $fp = fopen ("Ketvirtas_dvitaskiai.txt", "r+");
    $n = file("Ketvirtas_dvitaskiai.txt");
    fclose($fp);
    ...
    if (!file_exists("Tritaskiai/4.txt")) { // patikrina, ar egzistuoja failas
        exit ("No messages!");
    } else { // jei failas yra, jis yra skaitomas, t.y. atidaromas (fopen) ir tekstas is failo nuskaitomas ir perkeliamas i masyva, ir uzdaromas (fclose) "file"
        $fp = fopen ("Tritaskiai/4.txt", "r+");
        $n = file("Tritaskiai/4.txt");
        fclose($fp);
